...
public class Producer implements Runnable{
    ...
    public Producer(String name, String url) throws MalformedURLException {
        this.name = name;
        this.link = url;
    }
    
    public Producer(String name, String url, Buffer buffer) throws MalformedURLException {
        this.name = name;
        this.link = url;
        this.buffer = buffer;
    }
...
//                Thread object = new Thread(new Inserter(this.buffer,links.get(i)));
